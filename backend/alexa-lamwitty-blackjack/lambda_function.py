...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        Before we start, write down your confirmation code.
        """
        ...
        speak_output += " if you need to repeat that say repeat. To start the game say Play."
...
class PlayIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output += " You can bet from 10 dollars to 100 dollars. To bet say: I bet X dollars"
        return (
            handler_input.response_builder
            .speak(speak_output)
            .ask(speak_output)
